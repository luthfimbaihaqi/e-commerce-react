...
const NavbarItem = ({setNav}) => {
  ...
  <Link to="/" ><img src="/src/assets/images/LOGO_AthleticInstinctNew.png" alt="profile" class="w-48 object-contain pb-4 hover:cursor-pointer" /> </Link> 
...
<Link to="/" className='w-[75%] flex justify-center items-center rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-200'>
                    ...
                    <a  href="" target="_blank" className='w-[75%] flex justify-center items-center rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-200'>
                        <AiOutlineShoppingCart size={20} />
                        <span className='pl-4'>Cart(0)</span>
                    </a>
                    <Link  to="/login" className='w-[75%] flex justify-center items-center rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-200'>
